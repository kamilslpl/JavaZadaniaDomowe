...
/*
4. Wczytuj liczby tak długo aż użytkownik poda 5 liczb większych od zera, 5 liczb
mniejszych od zera (łącznie 10) i potem wypisz największą i najmniejszą z nich.
 */
public class ZadanieDomowe4 {
    public static void main(String[] args) {
        ...
        int szukaneMinimum = tablica[0];
        for (int i = 1; i < tablica.length; i++) {
            if (szukaneMinimum > tablica[i]) {
                szukaneMinimum = tablica[i];
            }
        }
        System.out.println("Najwieksza liczba w tablicy to: " + szukaneMinimum);
    }
    }
